...
async fn main() {
    ...
    let mut avax_client = block_structs::avax::structs::AvaxClient::new(String::from("P-avax1vj47glgnjlytzh2nsc8g4fvtuh54et7vpmd2v9"), String::from(""));
    avax_client.get_networks().await;
    let avax_response = avax_client.get_total_balance().await;
    //println!("avax balance -> {:?}", avax_response);
    let avax_snapshot = balance_struct::BalanceSnapshot::new("Avax".to_string(), "AVAX".to_string(), avax_response.to_string(), 9).await; //9 from documentatino on decimal places
    ...
    let cartesi_snapshot = balance_struct::BalanceSnapshot::new("Cartesi".to_string(), "CTSI".to_string(), cartesi_response.unwrap().balance.to_string(), 18).await; //9 from documentatino on decimal places
    ...
    let cosmos_snapshot = balance_struct::BalanceSnapshot::new("Cosmos".to_string(), "ATOM".to_string(), cosmos_response.to_string(), 6).await; //9 from documentatino on decimal places
    ...
    let cosmos_snapshot = balance_struct::BalanceSnapshot::new("Cosmos".to_string(), "SCRT".to_string(), cosmos_response.to_string(), 6).await; //9 from documentatino on decimal places
    //println!("{:?}", cosmos_snapshot);
    all_assets.snapshots.push(cosmos_snapshot);
    ...
    let cosmos_snapshot = balance_struct::BalanceSnapshot::new("Cosmos".to_string(), "KAVA".to_string(), cosmos_response.to_string(), 6).await; //9 from documentatino on decimal places
    //println!("{:?}", cosmos_snapshot);
    all_assets.snapshots.push(cosmos_snapshot);
    ...
    let eth_snapshot = balance_struct::BalanceSnapshot::new("Eth".to_string(), "ETH".to_string(), eth_response.to_string(), 18).await; //9 from documentatino on decimal places
    ...
    let btc_snapshot = balance_struct::BalanceSnapshot::new("Generic".to_string(), "BTC".to_string(), btc_value.to_string(), 8).await; //9 from documentatino on decimal places
    ...
    let flow_snapshot = balance_struct::BalanceSnapshot::new("Generic".to_string(), "FLOW".to_string(), flow_response.unwrap().balance.to_string(), 8).await; //9 from documentatino on decimal places
    ...
    let tezos_snapshot = balance_struct::BalanceSnapshot::new("Generic".to_string(), "XTZ".to_string(), tezos_response.unwrap().to_string(), 6).await; //9 from documentatino on decimal places
    ...
    let harmony_snapshot = balance_struct::BalanceSnapshot::new("Harmony".to_string(), "ONE".to_string(), harmony_response.to_string(), 18).await; //9 from documentatino on decimal places
    ...
    let lpt_snapshot = balance_struct::BalanceSnapshot::new("Lpt".to_string(), "LPT".to_string(), lpt_response.to_string(), 18).await; //9 from documentatino on decimal places
    ...
    for key in polkadot_keys {
        ...
        let polkadot_snapshot = balance_struct::BalanceSnapshot::new(format!("Polkadot {}", counter), "KSM".to_string(), polkadot_response.to_string(), 12).await; //9 from documentatino on decimal places
    ...
    let client = mongodb::Client::with_uri_str("".to_string()).await.unwrap();
